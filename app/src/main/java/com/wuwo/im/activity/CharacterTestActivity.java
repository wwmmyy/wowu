...
public class CharacterTestActivity extends BaseLoadActivity {
    ...
    private  TextView tv_question_sure, tv_question,tv_num,top_title;
    private  HashMap<String, String> anwsers = new HashMap<>();
    private  TextView return_back;
    private  View return_back0;
...
//        mRecyclerView.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.HORIZONTAL));
    ...
    private void initTop() {
        ...
        return_back0 = (View) findViewById(R.id.return_back0);
...
//                },
                    ...
                    LogUtils.i("上传到服务器的问题答案为：：：：：", jarry.toString());
