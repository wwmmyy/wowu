...
import com.wuwo.im.config.AppManager;
import com.wuwo.im.util.ExtraKey;
import com.wuwo.im.util.LocalImageHelper;
import com.wuwo.im.util.MyToast;
import com.wuwo.im.view.AlbumViewPager;
import com.wuwo.im.view.MatrixImageView;
...
/**
 * @author
 * @Description:用来实现聊天界面发送图片时多选
 * @date 2015-4-11
 */
public class ImageLocalAlbumDetailActivity extends BaseImageActivity implements MatrixImageView.OnSingleTapListener, View.OnClickListener
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (folders != null) {
                            ...
                            MyAdapter adapter = new MyAdapter(ImageLocalAlbumDetailActivity.this, folders);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.header_finish:
                AppManager.getAppManager().finishActivity(ImageLocalAlbumActivity.class);
...
//                    .setImageSize(new ImageSize(((AppContext) context.getApplicationContext()).getQuarterWidth(), 0))
        ...
        public View getView(final int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                ...
                convertView = inflater.inflate(R.layout.item_simple_list, null);
                viewHolder.imageView = (ImageView) convertView.findViewById(R.id.imageView);
                viewHolder.checkBox = (CheckBox) convertView.findViewById(R.id.checkbox);
                viewHolder.checkBox.setOnCheckedChangeListener(ImageLocalAlbumDetailActivity.this);
                convertView.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) convertView.getTag();
            }
//            void displayImage (String uri, ImageAware imageAware, DisplayImageOptions options, ImageLoadingListener listener, ImageLoadingProgressListener progressListener, int degree)
