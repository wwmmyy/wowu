...
import com.wuwo.im.util.StringUtils;
...
/**
 * Created by
 * 本地相册  用来实现聊天界面发送图片时多选
 */
public class ImageLocalAlbumActivity extends BaseImageActivity {
    ListView listView;
    ImageView progress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ImageLocalAlbumActivity.this, ImageLocalAlbumDetailActivity.class);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if(LocalImageHelper.getInstance().getCurrentSize()+LocalImageHelper.getInstance().getCheckedItems().size()>=8){
                MyToast.show(ImageLocalAlbumActivity.this,"最多选择8张图片");
                return;
            }
