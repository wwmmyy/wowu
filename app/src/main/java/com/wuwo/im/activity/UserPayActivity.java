...
/*        findViewById(R.id.memberpay_vip2).setOnClickListener(this);
        ...
        TextView user_login_name = (TextView) findViewById(R.id.user_login_name);
        user_login_name.setText(WowuApp.Name);

        ImageView iv_isvip = (ImageView) findViewById(R.id.iv_isvip);
        TextView tv_user_state = (TextView) findViewById(R.id.tv_user_state);

        if (getIntent().getBooleanExtra("isVip", false)) {
            iv_isvip.setVisibility(View.VISIBLE);
        } else {
            iv_isvip.setVisibility(View.GONE);
            tv_user_state.setText("当前未开通");
        }
       ...
       if(WowuApp.iconPath !=null && !WowuApp.iconPath.equals("")){
           draweeView.setImageURI(Uri.parse(WowuApp.iconPath));
       }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case ERROR:
                    ...
                    MyToast.show(mContext,"获取服务器信息失败");
                    break;
                case VISIABLE:
                    break;
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_xieyi:
                Intent temp2 = new Intent(this, WebviewDetailActivity.class);
            ...
            public void convert(CommRecyclerViewHolder viewHolder, userPay mainMessage) {
                ...
                switch (mainMessage.getType()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        viewHolder.getView(R.id.iv_userpay_pic).setBackgroundResource(R.drawable.vip_b);
                        break;
                    case 5:
                        viewHolder.getView(R.id.iv_userpay_pic).setBackgroundResource(R.drawable.svip_b);
                        break;
                }
...
//                startActivity(intent);
    ...
    public void loadServerData(String response, int flag) {
        LogUtils.i("支付列表:返回的结果为：：：：", response);
