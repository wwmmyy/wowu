...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height) {
        ...
        //获得屏幕的宽度和高度
        mScreenWidth = UtilsTool.getScreenWidth(mContext);
        mScreenHeight = UtilsTool.getScreenHeight(mContext);
    ...
    private void initUI() {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int index, long arg3) {
                ...
                if (mItemOnClickListener != null) mItemOnClickListener.onItemClick(
                        mActionItems.get(index), index);
            }
        });
    }
...
//                    textView.setTextColor(mContext.getResources().getColor(item.color));
//
...
//                    textView.setSingleLine(true);
                    ...
                    textView= (TextView) convertView.findViewById(R.id.popup_item);
                    textView.setTextColor(mContext.getResources().getColor(item.color));
