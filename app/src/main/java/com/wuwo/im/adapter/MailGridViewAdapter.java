 ...
 * @param <T>
 */
public class MailGridViewAdapter<T> extends BaseAdapter {

	private List<T> mList = new ArrayList<T>();
	private Activity mActivity;

	public MailGridViewAdapter(Activity mActivity) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
		    ...
		    if (position == mList.size()) {
		        holder.imageView.setImageBitmap(BitmapFactory.decodeResource(mActivity.getResources(),
	                        R.drawable.icon_addpic_focused));
//		        holder.textView.setText("会议材料");
