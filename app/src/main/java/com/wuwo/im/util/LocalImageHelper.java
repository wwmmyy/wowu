...
public class LocalImageHelper {
    ...
    public String setCameraImgPath() {
        String foloder= WowuApp.getInstance().getCachePath()
                + "/PostPicture/";
    ...
    private LocalImageHelper(WowuApp context) {
    ...
    public static void init(WowuApp context) {
