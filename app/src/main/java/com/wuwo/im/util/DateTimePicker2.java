...
public class DateTimePicker2 extends FrameLayout {
    ...
    public DateTimePicker2(Context context) {
        ...
        inflate(context, R.layout.datedialog_date_choose2, this);
...
//        mMinuteSpinner1.setValue(mMinute1);
    ...
    public interface OnDateTimeChangedListener {
        void onDateTimeChanged(DateTimePicker2 view, int year, int month, int day, int hour,
